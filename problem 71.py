...
# PLEASE NOTE THAT YOU CAN CHANGE THE 3 AND 7 TO BE ANY FRACTION
# SIMPLY CHANGE THE 3 AND 7 IN THE LOOP TO ANY VARIABLES

from math import ceil

closest_proper_fraction = 0

cpf_numerator = None
cpf_denominator = None

for d in range(1000000, 0, -1):
    n = ceil(3 * d / 7) - 1
    fraction = n / d

    if fraction > closest_proper_fraction:
        closest_proper_fraction = fraction
        cpf_numerator = n
        cpf_denominator = d

print(cpf_numerator, cpf_denominator)
